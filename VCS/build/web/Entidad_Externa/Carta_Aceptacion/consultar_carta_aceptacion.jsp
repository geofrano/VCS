<%-- 
    Document   : Consultar Carta de Aceptacion
...
<fieldset>
    <legend><h1 class="alineado3">Consultar Carta de Aceptacion</h1></legend>
    <br>
    <div class="list-group" id="div_datos"></div>
    <table class="table table-hover table-responsive">
        <tr title="Si no ha ingresado la Carta Compromiso no podra generar la carta de aceptacion">
