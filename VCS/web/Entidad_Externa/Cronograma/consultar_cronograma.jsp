...
<fieldset>
    <legend><h1 class="alineado3">Consultar Cronograma</h1></legend>
    <br>
    ...
    <table class="table table-hover table-responsive">
        <tr>
            ...
            <td>
                <img width="30px" height="30px" class="img-circle" src="../../images/agregar.jpg" title="Escoja una carta compromiso y presione aqui para ingresar el cronograma" ng-click="carga_ingreso()"/>
            </td>
        </tr>
    </table>
</fieldset>
