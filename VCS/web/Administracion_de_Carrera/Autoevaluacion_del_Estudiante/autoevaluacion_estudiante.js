        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each(data.items, function(index, article) {
                    cont = cont + 1;
                    $tabla.append("<tr title=\"Si no ha ingresado la ficha del estudiante no podra generar la Autoevaluacion del estudiante\"><td><input type=\"hidden\" name=\"cc_id_" + cont + "\" id=\"cc_id_" + cont + "\" value=\"" + article.id_cc + "\" >" + article.id_cc + "</td>\n" +
...
function imprime(cont) {
    ...
    document.getElementById("frm_ficha").action = ruta + "/Administracion_de_Carrera/Autoevaluacion_del_Estudiante/imprime_autoeval_estudiante.jsp";
