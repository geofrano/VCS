...
<fieldset>
    <legend><h1 class="alineado3">Consultar Informe del Tutor</h1></legend>
    <br>
    <div class="list-group" id="div_datos"></div>
    <table class="table table-hover table-responsive">
        <tr title="Si no ha ingresado la ficha del estudiante no podra generar el informe del tutor">
...
<table id="tbl_estudiante" class="table table-hover table-responsive">
    <tr title="Si no ha ingresado la ficha del estudiante no podra generar el informe del estudiante">
