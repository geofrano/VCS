            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(data.items, function(index, article) {
                        cont = cont + 1;
                        $tabla.append("<tr title=\"Si no ha ingresado la ficha del estudiante no podra generar la peticion de aprobacion\"><td><input type=\"hidden\" name=\"cc_id_" + cont + "\" id=\"cc_id_" + cont + "\" value=\"" + article.id_cc + "\" >" + article.id_cc + "</td>\n" +
...
function imprime(cont) {
    ...
    document.getElementById("frm_ficha").action = ruta + "/Administracion_de_Carrera/Peticion_de_Aprobacion/imprime_peticion_aprobacion.jsp";
