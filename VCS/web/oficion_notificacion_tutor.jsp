<%-- 
    Document   : oficion_notificacion_tutor
    Created on : 11/01/2016, 09:45:33 PM
...
<html ng-app="VCS">
    ...
    <body onload="carga()" ng-open="carga()" ng-controller="ControladorVCS">
         <form action="" method="POST" id="frm_carga" name="frm_carga">
            ...
            <input type="hidden" value="cont_oficion_notificacion_tutor" id="nombre_pagina" name="nombre_pagina" />
        </form>
    </body>
</html>