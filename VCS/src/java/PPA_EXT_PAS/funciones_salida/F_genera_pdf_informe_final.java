 ...
 */
public class F_genera_pdf_informe_final extends HttpServlet {
        ...
        try {
            ...
            if ((carta_comp.size() != 0)) {
                try {
                    ...
                    //Para que se muestre
                    response.setHeader("Content-Disposition", "inline; filename=Informe_Final.pdf");
                    ...
                    objTable.dibujaPdfInformeFinal(document, ruta_imagenes, ls_dimension, carta_comp, relativeWebPathArchivos, cod_carta_comp, institucion, sede);
                    ...
                    if (estado.equals("11")){
                        String actualiza = ficha.actualiza_estado_cc(cod_carta_comp, "12");
                    }
