 ...
 */
public class Genera_pdf_maestro {
    public void dibujaPdfTodos(Document document, String ruta_imagen, float dimension[], List< Carta_Compromiso> carta_comp, String ruta, String cod_cc,String institucion, String sede){
        float[] widths = new float[dimension.length];
	try {
		document.open();
	} catch (Exception ex) {
            Logger.getLogger(Genera_pdf_maestro.class.getName()).log(Level.SEVERE, null, ex);
        }
        try {
		...
		PdfPCell celda_1=new PdfPCell(campo1);
                ...
                comb8.add(new Chunk("NOMBRE PROGRAMA: ", FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD, Color.BLACK)));
                comb8.add(new Chunk(opciones.getNombre_programa(), FontFactory.getFont(FontFactory.HELVETICA, 8, Font.NORMAL, Color.BLACK)));
                document.add(comb8);
                ...
                comb10.add(new Chunk("INSTITUCIÓN O EMPRESA DE INTERÉS: ", FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD, Color.BLACK)));
                comb10.add(new Chunk(opciones.getNomb_empresa().toUpperCase(), FontFactory.getFont(FontFactory.HELVETICA, 8, Font.NORMAL, Color.BLACK)));
                document.add(comb10);*/
        ...
        //CRONOGRAMA DE ACTIVIDADES
         try {
            ...
            for (Iterator<Carta_Compromiso> it = carta_comp.iterator(); it.hasNext();) {
                ...
                int num_h_sem1=0;    int num_h_sem2=0;   int num_h_sem3=0;    int num_h_sem4=0;   int num_h_sem5=0;
                int num_h_sem6=0;    int num_h_sem7=0;   int num_h_sem8=0;    int num_h_sem9=0;   int num_h_sem10=0;
                int num_h_sem11=0;   int num_h_sem12=0;  int num_h_sem13=0;   int num_h_sem14=0;  int num_h_sem15=0;
				
                String valor_sem1="";  String valor_sem2="";  String valor_sem3="";  String valor_sem4="";  String valor_sem5="";
                String valor_sem6="";  String valor_sem7="";  String valor_sem8="";  String valor_sem9="";  String valor_sem10="";
                String valor_sem11=""; String valor_sem12=""; String valor_sem13=""; String valor_sem14=""; String valor_sem15="";
                ...
                for (Iterator<Carta_Compromiso> it2 = carta_comp3_act.iterator(); it2.hasNext();) {
                    ...
                    valor_sem1="";	valor_sem2="";	valor_sem3="";	valor_sem4="";	valor_sem5="";	valor_sem6="";	valor_sem7="";	valor_sem8="";
                    valor_sem9="";  valor_sem10=""; valor_sem11=""; valor_sem12=""; valor_sem13=""; valor_sem14=""; valor_sem15="";
