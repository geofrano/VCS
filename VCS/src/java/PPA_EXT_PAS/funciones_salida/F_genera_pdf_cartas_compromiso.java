 ...
 */
public class F_genera_pdf_cartas_compromiso extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if ((carta_comp.size() != 0)) {
                try {
                    ...
                    //Para que se muestre
                    response.setHeader("Content-Disposition", "inline; filename=Carta_compromiso.pdf");
                    ...
                    objTable.dibujaPdfCartaCompromiso(document,ruta_imagenes, ls_dimension, carta_comp, relativeWebPathArchivos);
