 ...
 */
@WebServlet(name = "F_graba_Cronograma", urlPatterns = {"/F_graba_Cronograma"})
public class F_graba_Cronograma extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (accion.equals("E")){
                ...
                String resultado=cronograma.procesar_peticion(accion);
                out.println(resultado);
            }
        }
    }
