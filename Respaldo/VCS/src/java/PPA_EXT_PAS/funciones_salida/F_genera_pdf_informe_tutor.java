 ...
 */
public class F_genera_pdf_informe_tutor extends HttpServlet {
        ...
        try {
            ...
            if ((carta_comp.size() != 0)) {
                try {
                    ...
                    //Para que se muestre
                    response.setHeader("Content-Disposition", "inline; filename=Informe_Tutor.pdf");
                    ...
                    objTable.dibujaPdfInformeTutor(document, ruta_imagenes, ls_dimension, carta_comp, relativeWebPathArchivos, cod_carta_comp, institucion, sede);
                    ...
                    if (estado.equals("10")){
                        String actualiza = ficha.actualiza_estado_cc(cod_carta_comp, "11");
                    }
