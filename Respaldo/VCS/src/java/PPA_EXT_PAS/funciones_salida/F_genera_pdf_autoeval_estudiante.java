 ...
 */
public class F_genera_pdf_autoeval_estudiante extends HttpServlet {
        ...
        try {
            ...
            if ((carta_comp.size() != 0)) {
                try {
                    ...
                    //Para que se muestre
                    response.setHeader("Content-Disposition", "inline; filename=Autoevaluacion_Estudiante.pdf");
                    ...
                    objTable.dibujaPdfAutoevalEstudiante(document, ruta_imagenes, ls_dimension, carta_comp, relativeWebPathArchivos, cod_carta_comp, institucion, sede);
                    ...
                    if (estado.equals("9")){
                        String actualiza = ficha.actualiza_estado_cc(cod_carta_comp, "10");
                    }
