 ...
 */
//Oficio de Notificacion al Tutor
public class F_genera_pdf_of_not_tutor extends HttpServlet {
        ...
        try {
            ...
            if ((carta_comp.size() != 0)) {
                try {
                    ...
                    //Para que se muestre
                    response.setHeader("Content-Disposition", "inline; filename=Oficio_notificacion_Tutor.pdf");
                    ...
                    objTable.dibujaPdfNotificacionTutor(document, ruta_imagenes, ls_dimension, carta_comp, relativeWebPathArchivos, cod_carta_comp, institucion, sede);
                    ...
                    if (estado.equals("6")){
                        String actualiza = ficha.actualiza_estado_cc(cod_carta_comp, "7");
                    }
            ...
            response.sendRedirect(response.encodeRedirectURL("/VCS/Administracion_de_Carrera/Oficio_Notificacion_Tutor/notificacion_tutor.jsp"));
        }
    }
