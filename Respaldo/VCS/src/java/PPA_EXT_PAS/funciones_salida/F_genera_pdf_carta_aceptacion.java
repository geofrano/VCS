 ...
 */
public class F_genera_pdf_carta_aceptacion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List< Carta_Compromiso> carta_comp = ficha_est.mostrar_carta_compromiso(cod_carta_comp);
            ...
            if ((carta_comp.size() != 0)) {
                try {
                    ...
                    //Para que se muestre
                    response.setHeader("Content-Disposition", "inline; filename=Carta_aceptacion.pdf");
                    ...
                    objTable.dibujaPdfCartaAceptacion(document, ruta_imagenes, ls_dimension, carta_comp, relativeWebPathArchivos, cod_carta_comp, institucion, sede);
                    ...
                    if (estado.equals("2")){
                        String actualiza = ficha.actualiza_estado_cc(cod_carta_comp, "3");
                    }
            ...
            System.out.println("ERROR " + e);
            response.sendRedirect(response.encodeRedirectURL("/VCS/Administracion_de_Carrera/Autoevaluacion_del_Estudiante/autoevaluacion_estudiante.jsp"));
        }
    }
