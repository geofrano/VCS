 ...
 */
public class F_genera_pdf_peticion_verbal extends HttpServlet {
        ...
        try {
            ...
            if ((carta_comp.size() != 0)) {
                try {
                    ...
                    //Para que se muestre
                    response.setHeader("Content-Disposition", "inline; filename=Peticion_Verbal.pdf");
                    ...
                    objTable.dibujaPdfPeticionVerbal(document, ruta_imagenes, ls_dimension, carta_comp, relativeWebPathArchivos, cod_carta_comp, institucion, sede);
                    ...
                    if (estado.equals("A") || estado.equals("1")){
                       String actualiza = ficha.actualiza_estado_cc(cod_carta_comp, "2"); 
                    }
