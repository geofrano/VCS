 ...
 */
@WebServlet(name = "F_genera_pdf_cronograma", urlPatterns = {"/F_genera_pdf_cronograma"})
public class F_genera_pdf_cronograma extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if ((carta_comp.size() != 0)) {
                try {
                    ...
                    objTable.dibujaPdfCronograma(document,ruta_imagenes, ls_dimension, carta_comp, relativeWebPathArchivos);
                    ...
                    if (estado.equals("3")||estado.equals("1")||estado.equals("0")||estado.equals("A")){
                        String actualiza = ficha.actualiza_estado_cc(cod_carta_comp, "4");
                    }
            ...
            response.sendRedirect(response.encodeRedirectURL("/VCS/Entidad_Externa/Carta_Compromiso/carta_compromiso.jsp"));
        }
    }
