<%-- 
    Document   : Consultar Oficio de Notificacion del Tutor
...
<fieldset>
    <legend><h1 class="alineado3">Consultar Autoevaluación del Estudiante</h1></legend>
    <br>
    <div class="list-group" id="div_datos"></div>
    <table class="table table-hover table-responsive">
        <tr title="Si no ha ingresado la ficha del estudiante no podra generar la Autoevaluacion del estudiante">
